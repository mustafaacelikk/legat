...
import 'package:herseyim/screens/reminders/add_reminder_screen.dart';
import 'package:herseyim/models/profile_model.dart';
import 'test_helpers.dart';

void main() {
  testWidgets(
      'Hatırlatıcı ekle ekranı çok sayıda profille yatayda kaydırılabilir kalır (dikeyde büyümez)',
    ...
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: const MaterialApp(home: AddReminderScreen()),
      ),
    );
